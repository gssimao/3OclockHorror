...
public class clockCntrl1 : MonoBehaviour //This is a copy to be maintained in Noah directory - For active modifications. Do not port to main without consultation.
{
